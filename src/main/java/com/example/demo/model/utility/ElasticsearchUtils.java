package com.example.demo.model.utility;//package gs.com.gses.model.utility;
//
//import cn.hutool.core.util.StrUtil;
//import cn.hutool.json.JSONObject;
//import com.fasterxml.jackson.core.JsonProcessingException;
//import com.fasterxml.jackson.databind.ObjectMapper;
//import com.fnd.core.utils.ReflectUtils;
//import com.fnd.elasticsearch.model.PropertiesMapping;
//import com.fnd.elasticsearch.model.RelationModel;
...
//     * @return
//     */
//    public <T> boolean putMapping(String indexName,T elasticsearchModel){
//        if (StrUtil.isNotEmpty(indexName)) {
//            createIndexIfNotExist(indexName);
//            return elasticsearchRestTemplate.indexOps(IndexCoordinates.of(indexName)).putMapping(elasticsearchModel.getClass());
//        }
//        return Boolean.FALSE;
//    }
//
...
//            return result != null && !result.isEmpty() ? result.get(0).getId() : null;
//        }
//        return null;
//    }
//
...
//        if (existIndex(indexName) && StrUtil.isNotEmpty(docId) && tClass != null) {
...
//        if (existIndex(indexName) && StrUtil.isNotEmpty(docId)) {
...
//        if (StrUtil.isNotEmpty(indexName) && elasticsearchModel != null) {
...
//        Assert.isTrue(fieldValue != null && StrUtil.isNotEmpty(fieldValue.toString()),
...
//        validDocument(elasticsearchModel);
//        Assert.isTrue(StrUtil.isNotEmpty(subRelationName), "parameter `subRelationName` must not be null");
...
//                    Assert.isTrue(StrUtil.isNotEmpty(relationModel.getParent()), elasticsearchModel.getClass().getSimpleName() + "." + field.getName() + ".parent value must not be null.");
